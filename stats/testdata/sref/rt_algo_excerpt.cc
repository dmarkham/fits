/*
 * Excerpted from RawTherapee rt_algo.cc for use as a test oracle only.
 * This file is NOT part of the fits library — it is a build-time test
 * dependency that is compiled into a standalone binary (sref) and never
 * linked into or distributed with the Go code.
 *
 ...
 *
 *  See https://www.gnu.org/licenses/ for the full GPL-3.0 text.
 */
#include <cassert>
